export const metadata = {
  title: 'Privacy Policy — Xerodirt Professional Cleaning',
    ...
    <>
      <section className="page-hero">
        <div className="container">
          ...
          <p>We value your trust and are committed to keeping your information secure and confidential.</p>
        </div>
      </section>
               ...
               <p></p>
                <div className="space-y-8 text-gray-300 leading-relaxed">
                                    ...
                                    <div>
                                        ...
                                        <b class="text-black"> 9826614177</b>
                                        ...
                                        <b class="text-black"> https://xerodirt.com/ </b>
                                        (hereinafter referred to as 
                                        Platform
                                        ). Please note that you may be able to browse 
                                        ...
                                        any information. If you receive an email, a call from a person/association claiming to be <b class="text-black"> 9826614177 </b>
