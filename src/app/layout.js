  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        {/* Google tag (gtag.js) */}
        <Script 
          src="https://www.googletagmanager.com/gtag/js?id=AW-18462388198" 
        ...
        <Script
          ...
          fbq('init', '4293199580939619');
          fbq('track', 'PageView');
        `}}
        />
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=4293199580939619&ev=PageView&noscript=1" />
        </noscript>
        {/* End Meta Pixel Code */}
