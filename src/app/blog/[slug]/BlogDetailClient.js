...
export default function BlogDetailClient({ post }) {
  ...
  const shareUrl = typeof window !== 'undefined' ? window.location.href : `https://xerodirt.com/blog/${post.slug}`;
  const shareText = `${post.title} — Xerodirt Blog`;
  ...
  return (
    <div className="blog-share-section" id="blog-share-section">
