    ...
    <>
      <section className="page-hero">
        <div className="container">
          <span className="section-label">T&C</span>
              ...
              <span className="section-label">Last updated: May 23, 2026</span>
               ...
               <p></p>
                <div className="space-y-8 text-gray-300 leading-relaxed">
                                    ...
                                    <div>
                                        <p>
                                        1. This document is an electronic record in terms of Information Technology
                                        ...
                                        <p className="mt-3">
                                        2. This document is published in accordance with the provisions of Rule 3 (1)
                                        ...
                                        Use for access or usage of domain name <b class="text-black"> https://xerodirt.com/ </b>('Website'),
                                        including the related mobile site and mobile application (hereinafter
                                        referred to as 'Platform').
                                        </p>

                                        <p className="mt-3">
                                        3. The Platform is owned by <b class="text-black"> 9826614177</b>, a company incorporated under the Companies Act,
                                        1956 with its registered office at:
                                        

                                        
                                        <b class="text-black"> Phase 3, Hinjawadi Rajiv Gandhi Infotech Park,
                                        Hinjawadi, Man, Maharashtra 411057 </b>
                                    ...
                                    <div>
                                        ...
                                        Owner and these terms and conditions including the policies constitute Your
                                        binding obligations, with Platform Owner. These Terms of Use relate to your
                                        use of our website, goods (as applicable) or services (as applicable)
                                        (collectively, 'Services'). Any terms and conditions proposed by You which
                                        are in addition to or which conflict with these Terms of Use are expressly
                                        ...
                                        <p className="mt-3">
                                        5. For the purpose of these Terms of Use, wherever the context so requires
                                        ...
                                        <p>
                                        1. To access and use the Services, you agree to provide true, accurate and
                                        ...
                                        that is unlawful, illegal or forbidden by these Terms, or Indian or local
                                        ...
                                        due to or arising out of Your breach of this Terms of Use, privacy Policy
                                        and other Policies, or Your violation of any law, rules or regulations or
                                        the rights (including infringement of intellectual property rights) of a
                                        third party.
                                        </p>
